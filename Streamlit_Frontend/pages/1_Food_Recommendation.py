...
class Display:
    ...
    def display_meal_choices(self,person,recommendations):    
        ...
        if len(recommendations)==3:
            ...
            with launch_column:
                lunch_choice=st.selectbox(f'Choose your launch:',[recipe['Name'] for recipe in recommendations[1]])
            with dinner_column:
            ...
            with lunch_column:
                lunch_choice=st.selectbox(f'Choose your launch:',[recipe['Name'] for recipe in recommendations[2]])
            with dinner_column:
